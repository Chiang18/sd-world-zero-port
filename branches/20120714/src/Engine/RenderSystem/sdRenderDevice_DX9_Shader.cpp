...
//-------------------------------------------------------------------------------------------------
void sdRenderDevice_DX9::SetGlobalShaderConstant(const sdFixedString& szName, uint uiSize, const void* pData)
{
	NiD3DShaderFactory::UpdateGlobalShaderConstant(szName, uiSize, pData);
}
//-------------------------------------------------------------------------------------------------
void sdRenderDevice_DX9::GetGlobalShaderConstant(const sdFixedString& szName, uint& uiSize, const void*& pData)
{
