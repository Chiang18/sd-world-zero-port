...
typedef	ULONG	(STDMETHODCALLTYPE	*T_DeviceRelease)(IDirect3DDevice9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_SurfaceRelease)(IDirect3DSurface9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_CubeSurfaceRelease)(IDirect3DSurface9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_VolumeRelease)(IDirect3DVolume9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_VertexBufferRelease)(IDirect3DVertexBuffer9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_IndexBufferRelease)(IDirect3DIndexBuffer9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_VertexDeclarationRelease)(IDirect3DVertexDeclaration9* pThis);
typedef	ULONG	(STDMETHODCALLTYPE	*T_StateBlockRelease)(IDirect3DStateBlock9* pThis);
