...
///////////////////////////////////////////////////////////////////////////////
// GetWinVersionString
std::wstring CXWinVersion::GetWinVersionString()
{
	...
	switch (nVersion)
	{
		...
		case WIN7:		strVersion = _T("Windows 7/Windows Server 2008 R2");	break;
		case WIN8:		strVersion = _T("Windows 8/Windows Server 2012");		break;
...
std::wstring CXWinVersion::GetVistaProductString()
{
	std::wstring strProductType = _T("");
