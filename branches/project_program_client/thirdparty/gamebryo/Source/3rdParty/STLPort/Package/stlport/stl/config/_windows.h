...
#      include <stlport/windef.h> /* needed for basic windows types */
...
#        if defined (x86)
#          include <stlport/winbase.h> /* needed for inline versions of Interlocked* functions */
#        endif
