...
#    include <stlport/machine/builtins.h>
...
#    include <stlport/nwthread.h>
#    include <stlport/nwsemaph.h>

#  elif defined(_STLP_OS2THREADS)

#    if defined (__GNUC__)
#      define INCL_DOSSEMAPHORES
#      include <stlport/os2.h>
#    else
