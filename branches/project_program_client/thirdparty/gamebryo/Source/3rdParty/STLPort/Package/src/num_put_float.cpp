...
#  if defined (__sun)
#    include <stlport/floatingpoint.h>
#  endif
...
#    include <stlport/values.h>
#    include <stlport/nan.h>
#  endif
...
#  include <stlport/fp.h>
#endif

#if defined (__CYGWIN__)
#  include <stlport/ieeefp.h>
#endif

#if defined (__MSL__)
#  include <stlport/cstdlib>  // for atoi
#  include <stlport/cstdio>  // for snprintf
