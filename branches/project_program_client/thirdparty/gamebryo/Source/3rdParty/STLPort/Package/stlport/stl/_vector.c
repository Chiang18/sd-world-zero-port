...
#  ifdef __vector
#    error "_STLP_USE_PTR_SPECIALIZATIONS cannot be used with a compiler that supports altivec vectors"
#  endif
#  define vector _STLP_PTR_IMPL_NAME(vector)
#elif defined (_STLP_DEBUG)
#  ifdef __vector
#    error "_STLP_DEBUG cannot be used with a compiler that supports altivec vectors"
#  endif
...
#if defined (_STLP_USE_PTR_SPECIALIZATIONS) || defined (_STLP_DEBUG) 
#  undef vector
_STLP_MOVE_TO_STD_NAMESPACE
#endif
