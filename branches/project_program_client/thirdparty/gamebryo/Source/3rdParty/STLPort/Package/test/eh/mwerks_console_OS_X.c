...
#include <stlport/ansi_parms.h>
#include <stlport/size_t.h>
#include <stlport/console.h>
 ...
 * JWW 020418 Use __std() for all size_t, and #include <stlport/size_t.h> to get proper C++ definitions
 */