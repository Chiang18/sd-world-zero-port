...
//@{
	...
	*/
	...
	\return The static friction with static shapes.
 	...
 	@see NxFluidDesc.staticFrictionForStaticShapes
	*/
	virtual		NxReal				getStaticFrictionForStaticShapes()					const	= 0;

	/**
	\brief Sets the static friction used for collision with static shapes.
	
	Must be 0 or greater.
 
 	\param friction The new static friction with static shapes
	...
	*/
	...
	\return The dynamic friction with dynamic shapes.
	...
	*/
	...
	\return The static friction with dynamic shapes.
	...
	<b>Platform:</b>
 	...
 	@see NxFluidDesc.staticFrictionForDynamicShapes
	*/
	...
	\param friction The new static friction with dynamic shapes.
