...
//  IDirect3D9					部分函数重载(*)
//	IDirect3D9Ex				部分函数重载(*)
//	IDirect3DBaseTexture9		部分函数重载
//	IDirect3DCubeTexture9		部分函数重载
//	IDirect3DDevice9			部分函数重载
//	IDirect3DDevice9Ex
//	IDirect3DIndexBuffer9		部分函数重载
//	IDirect3DPixelShader9
//	IDirect3DQuery9
//	IDirect3DResource9
//	IDirect3DStateBlock9		部分函数重载
//	IDirect3DSurface9			部分函数重载
//	IDirect3DSwapChain9			部分函数重载
//	IDirect3DSwapChain9Ex
//	IDirect3DTexture9			部分函数重载
//	IDirect3DVertexBuffer9		部分函数重载
//	IDirect3DVertexDeclaration9	部分函数重载
//	IDirect3DVertexShader9
//	IDirect3DVolume9			部分函数重载
//	IDirect3DVolumeTexture9		部分函数重载
//
// D3D Effect库有6个Interface:
//	ID3DXBaseEffect
//	ID3DXEffect
//	ID3DXEffectCompiler
//	ID3DXEffectPool
