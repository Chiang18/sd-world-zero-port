...
#include <stlport/boost/type_traits/is_integral.hpp>
#include <stlport/boost/type_traits/is_float.hpp>
#include <stlport/boost/type_traits/has_trivial_constructor.hpp>
#include <stlport/boost/type_traits/has_trivial_copy.hpp>
#include <stlport/boost/type_traits/has_trivial_assign.hpp>
#include <stlport/boost/type_traits/has_trivial_destructor.hpp>
#include <stlport/boost/type_traits/is_pod.hpp>
#include <stlport/boost/type_traits/is_pointer.hpp>
#include <stlport/boost/type_traits/is_reference.hpp>
#include <stlport/boost/type_traits/remove_cv.hpp>
#include <stlport/boost/type_traits/is_same.hpp>
