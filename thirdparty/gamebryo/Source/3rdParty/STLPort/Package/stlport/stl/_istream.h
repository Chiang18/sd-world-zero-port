...
#  include <stlport/stl/_ios.h>                  // For basic_ios<>.  Includes <iosfwd>.
#endif

#ifndef _STLP_INTERNAL_OSTREAM_H
#  include <stlport/stl/_ostream.h>              // Needed as a base class of basic_iostream.
#endif
...
#include <stlport/stl/_ctraits_fns.h>    // Helper functions that allow char traits
