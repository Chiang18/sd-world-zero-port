...
#  include <stlport/sys/stat.h>           // For stat
#  if !defined (_CRAY) && ! defined (__EMX__)
#    include <stlport/sys/mman.h>           // For mmap
#  endif
...
#  include <stlport/fcntl.h>
}
#  ifdef __APPLE__
#    include <stlport/sys/sysctl.h>
#  endif
#elif defined (_STLP_USE_WIN32_IO)
#  define WIN32_LEAN_AND_MEAN
#  include <stlport/windows.h>

#  ifdef __BORLANDC__
#      include <stlport/cfcntl.h>            // For _O_RDONLY, etc
#    include <stlport/sys/stat.h>         // For _fstat
#  elif !defined(_STLP_WCE)
#    include <stlport/io.h>               // For _get_osfhandle
#    include <stlport/fcntl.h>            // For _O_RDONLY, etc
#    include <stlport/sys/stat.h>         // For _fstat
#  endif
...
#    include <stlport/unistd.h>
#  else
#    include <stlport/io.h>
#  endif
#  include <stlport/fcntl.h>
#  include <stlport/sys/stat.h>
...
#  endif
#  if defined( __MSL__ )
#    include <stlport/unix.h>
#  endif
#  if defined(__ISCPP__)
#    include <stlport/c_locale_is/filestat.h>
#  endif
