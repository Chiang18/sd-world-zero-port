...
//Source enum: m:\FB\depot\Gamebryo\3.0BR\Media\Enums\efdMessageIDs.enum
...
namespace efd
{
    ...
    static const ClassID kMSGID_AssetConfigRequest               =       4150u; // 0x00001036
    static const ClassID kMSGID_AssetConfigResponse              =       4151u; // 0x00001037
    static const ClassID kMSGID_AssetConfigNotify                =       4152u; // 0x00001038
    static const ClassID kMSGID_AssetBrowseInfoRequest           =       4153u; // 0x00001039
    static const ClassID kMSGID_AssetBrowseInfoResponse          =       4154u; // 0x0000103A
    static const ClassID kMSGID_AssetTagsInfoRequest             =       4155u; // 0x0000103B
    static const ClassID kMSGID_AssetTagsInfoResponse            =       4156u; // 0x0000103C
    static const ClassID kMSGID_AssetLocateEnumResponse          =       4157u; // 0x0000103D
    static const ClassID kMSGID_TestShutdown                     =       4158u; // 0x0000103E
    static const ClassID kMSGID_StartTick                        =       4159u; // 0x0000103F
    static const ClassID kMSGID_ClientLogServiceRequest          =       4160u; // 0x00001040
    static const ClassID kMSGID_ClientLogServiceResponse         =       4161u; // 0x00001041
    static const ClassID kMSGID_ServiceDiscoveryRequest          =       4162u; // 0x00001042
    static const ClassID kMSGID_ServiceDiscoveryResponse         =       4163u; // 0x00001043
    static const ClassID kMSGID_ServerToClientMessage            =       4164u; // 0x00001044
